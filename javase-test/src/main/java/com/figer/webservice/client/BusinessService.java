 ...
 * 
 */
@WebServiceClient(name = "BusinessService", targetNamespace = "http://com.figer.webService/client", wsdlLocation = "http://localhost:9527/BusinessService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BUSINESSSERVICE_QNAME = new QName("http://com.figer.webService/client", "BusinessService");
    ...
    public Business getBusinessPort() {
        return super.getPort(new QName("http://com.figer.webService/client", "BusinessPort"), Business.class);
    }
    ...
    public Business getBusinessPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://com.figer.webService/client", "BusinessPort"), Business.class, features);
    }
